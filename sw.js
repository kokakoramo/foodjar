const CACHE='food-jar-v6';
const ASSETS=['./','./index.html','./styles.css','./app.js','./config.js','./cloud.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/demo-sticker.png'];
